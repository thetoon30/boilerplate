...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        .state('main', {
            abstract: true,
            url: "/",
            templateUrl: "app/module/layout/layout.html",
            controller: 'LayoutController',
            resolve: {
                loggedInUser: function ($q, $http, $location, userService) {
        ...
        .state('user', {
            ...
            views: {
                mainView: {
                    templateUrl: "app/module/user/container.html"
                }
            },
        ...
        .state('user.add', {
            ...
            views: {
                userView: {
                    templateUrl: "app/module/user/add.html",
                    controller: 'UserAccountController'
                }
            },
            data: { pageTitle: 'User Manage' }
        ...
        .state('user.edit', {
            ...
            views: {
                userView: {
                    templateUrl: "app/module/user/edit.html",
                    controller: 'UserAccountController'
                }
            },
            data: { pageTitle: 'User Manage' }
        ...
        .state('dashboards', {
            abstract: true,
            url: "/dashboards",
            templateUrl: "app/module/layout/content.html",
        })
        .state('dashboards.dashboard_1', {
            url: "/dashboard_1",
            templateUrl: "app/module/dashboard/dashboard_1.html",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('dashboards.dashboard_2', {
            url: "/dashboard_2",
            templateUrl: "app/module/dashboard/dashboard_2.html",
        ...
        .state('dashboards.dashboard_3', {
            url: "/dashboard_3",
            templateUrl: "app/module/dashboard/dashboard_3.html",
        ...
        .state('dashboards_top', {
            abstract: true,
            url: "/dashboards_top",
            templateUrl: "app/module/layout/content_top_navigation.html",
        })
        .state('dashboards_top.dashboard_4', {
            url: "/dashboard_4",
            templateUrl: "app/module/dashboard/dashboard_4.html",
        ...
        .state('dashboards.dashboard_4_1', {
            url: "/dashboard_4_1",
            templateUrl: "app/module/dashboard/dashboard_4_1.html",
            data: { pageTitle: 'Dashboard 4' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
        ...
        .state('dashboards.dashboard_5', {
            url: "/dashboard_5",
            templateUrl: "app/module/dashboard/dashboard_5.html",
        ...
        .state('layouts', {
            url: "/layouts",
            templateUrl: "app/module/layout/layouts.html",
        ...
        .state('charts.flot_chart', {
            url: "/flot_chart",
            templateUrl: "app/module/chart/graph_flot.html",
        ...
        .state('charts.rickshaw_chart', {
            url: "/rickshaw_chart",
            templateUrl: "app/module/chart/graph_rickshaw.html",
        ...
        .state('charts.peity_chart', {
            url: "/peity_chart",
            templateUrl: "app/module/chart/graph_peity.html",
        ...
        .state('charts.sparkline_chart', {
            url: "/sparkline_chart",
            templateUrl: "app/module/chart/graph_sparkline.html",
        ...
        .state('charts.chartjs_chart', {
            url: "/chartjs_chart",
            templateUrl: "app/module/chart/chartjs.html",
        ...
        .state('charts.chartist_chart', {
            url: "/chartist_chart",
            templateUrl: "app/module/chart/chartist.html",
        ...
        .state('mailbox.inbox', {
            url: "/inbox",
            templateUrl: "app/module/mail/mailbox.html",
        ...
        .state('mailbox.email_view', {
            url: "/email_view",
            templateUrl: "app/module/mail/mail_detail.html",
            data: { pageTitle: 'Mail detail' }
        })
        .state('mailbox.email_compose', {
            url: "/email_compose",
            templateUrl: "app/module/mail/mail_compose.html",
        ...
        .state('mailbox.email_template', {
            url: "/email_template",
            templateUrl: "app/module/mail/email_template.html",
            data: { pageTitle: 'Mail compose' }
        })
        .state('widgets', {
            url: "/widgets",
            templateUrl: "app/module/widget/widgets.html",
        ...
        .state('metrics', {
            url: "/metrics",
            templateUrl: "app/module/metric/metrics.html",
        ...
        .state('forms.basic_form', {
            url: "/basic_form",
            templateUrl: "app/module/form/form_basic.html",
        ...
        .state('forms.advanced_plugins', {
            ...
            templateUrl: "app/module/form/form_advanced.html",
        ...
        .state('forms.wizard', {
            url: "/wizard",
            templateUrl: "app/module/form/form_wizard.html",
        ...
        .state('forms.wizard.step_one', {
            url: '/step_one',
            templateUrl: 'app/module/form/step_one.html',
            data: { pageTitle: 'Wizard form' }
        })
        .state('forms.wizard.step_two', {
            url: '/step_two',
            templateUrl: 'app/module/form/step_two.html',
            data: { pageTitle: 'Wizard form' }
        })
        .state('forms.wizard.step_three', {
            url: '/step_three',
            templateUrl: 'app/module/form/step_three.html',
            data: { pageTitle: 'Wizard form' }
        })
        .state('forms.file_upload', {
            url: "/file_upload",
            templateUrl: "app/module/form/form_file_upload.html",
        ...
        .state('forms.text_editor', {
            url: "/text_editor",
            templateUrl: "app/module/form/form_editors.html",
        ...
        .state('app.contacts', {
            url: "/contacts",
            templateUrl: "app/module/app_view/contacts.html",
            data: { pageTitle: 'Contacts' }
        })
        .state('app.contacts_2', {
            url: "/contacts_2",
            templateUrl: "app/module/app_view/contacts_2.html",
            data: { pageTitle: 'Contacts 2' }
        })
        .state('app.profile', {
            url: "/profile",
            templateUrl: "app/module/app_view/profile.html",
            data: { pageTitle: 'Profile' }
        })
        .state('app.profile_2', {
            url: "/profile_2",
            templateUrl: "app/module/app_view/profile_2.html",
        ...
        .state('app.projects', {
            url: "/projects",
            templateUrl: "app/module/app_view/projects.html",
            data: { pageTitle: 'Projects' }
        })
        .state('app.project_detail', {
            url: "/project_detail",
            templateUrl: "app/module/app_view/project_detail.html",
            data: { pageTitle: 'Project detail' }
        })
        .state('app.file_manager', {
            url: "/file_manager",
            templateUrl: "app/module/app_view/file_manager.html",
            data: { pageTitle: 'File manager' }
        })
        .state('app.calendar', {
            url: "/calendar",
            templateUrl: "app/module/app_view/calendar.html",
        ...
        .state('app.faq', {
            url: "/faq",
            templateUrl: "app/module/app_view/faq.html",
            data: { pageTitle: 'FAQ' }
        })
        .state('app.timeline', {
            url: "/timeline",
            templateUrl: "app/module/app_view/timeline.html",
            data: { pageTitle: 'Timeline' }
        })
        .state('app.pin_board', {
            url: "/pin_board",
            templateUrl: "app/module/app_view/pin_board.html",
            data: { pageTitle: 'Pin board' }
        })
        .state('app.invoice', {
            url: "/invoice",
            templateUrl: "app/module/app_view/invoice.html",
            data: { pageTitle: 'Invoice' }
        })
        .state('app.blog', {
            url: "/blog",
            templateUrl: "app/module/app_view/blog.html",
            data: { pageTitle: 'Blog' }
        })
        .state('app.article', {
            url: "/article",
            templateUrl: "app/module/app_view/article.html",
            data: { pageTitle: 'Article' }
        })
        .state('app.issue_tracker', {
            url: "/issue_tracker",
            templateUrl: "app/module/app_view/issue_tracker.html",
            data: { pageTitle: 'Issue Tracker' }
        })
        .state('app.clients', {
            url: "/clients",
            templateUrl: "app/module/app_view/clients.html",
            data: { pageTitle: 'Clients' }
        })
        .state('app.teams_board', {
            url: "/teams_board",
            templateUrl: "app/module/app_view/teams_board.html",
            data: { pageTitle: 'Teams board' }
        })
        .state('app.social_feed', {
            url: "/social_feed",
            templateUrl: "app/module/app_view/social_feed.html",
            data: { pageTitle: 'Social feed' }
        })
        .state('app.vote_list', {
            url: "/vote_list",
            templateUrl: "app/module/app_view/vote_list.html",
        ...
        .state('pages.search_results', {
            url: "/search_results",
            templateUrl: "app/module/other_page/search_results.html",
            data: { pageTitle: 'Search results' }
        })
        .state('pages.empy_page', {
            url: "/empy_page",
            templateUrl: "app/module/other_page/empty_page.html",
        ...
        .state('exlogin', {
            url: "/exlogin",
            controller: "LoginController",
            templateUrl: "app/module/other_page/exregister.html",
            data: { pageTitle: 'exLogin', specialClass: 'gray-bg' }
        })
        .state('login_two_columns', {
            url: "/login_two_columns",
            templateUrl: "app/module/other_page/login_two_columns.html",
            data: { pageTitle: 'Login two columns', specialClass: 'gray-bg' }
        })
        .state('register', {
            url: "/register",
            templateUrl: "app/module/other_page/register.html",
            data: { pageTitle: 'Register', specialClass: 'gray-bg' }
        })
        .state('lockscreen', {
            url: "/lockscreen",
            templateUrl: "app/module/other_page/lockscreen.html",
            data: { pageTitle: 'Lockscreen', specialClass: 'gray-bg' }
        })
        .state('forgot_password', {
            url: "/forgot_password",
            templateUrl: "app/module/other_page/forgot_password.html",
            data: { pageTitle: 'Forgot password', specialClass: 'gray-bg' }
        })
        .state('errorOne', {
            url: "/errorOne",
            templateUrl: "app/module/other_page/errorOne.html",
            data: { pageTitle: '404', specialClass: 'gray-bg' }
        })
        .state('errorTwo', {
            url: "/errorTwo",
            templateUrl: "app/module/other_page/errorTwo.html",
        ...
        .state('ui.typography', {
            url: "/typography",
            templateUrl: "app/module/ui/typography.html",
            data: { pageTitle: 'Typography' }
        })
        .state('ui.icons', {
            url: "/icons",
            templateUrl: "app/module/ui/icons.html",
            data: { pageTitle: 'Icons' }
        })
        .state('ui.buttons', {
            url: "/buttons",
            templateUrl: "app/module/ui/buttons.html",
            data: { pageTitle: 'Buttons' }
        })
        .state('ui.tabs_panels', {
            url: "/tabs_panels",
            templateUrl: "app/module/ui/tabs_panels.html",
            data: { pageTitle: 'Panels' }
        })
        .state('ui.tabs', {
            url: "/tabs",
            templateUrl: "app/module/ui/tabs.html",
            data: { pageTitle: 'Tabs' }
        })
        .state('ui.notifications_tooltips', {
            url: "/notifications_tooltips",
            templateUrl: "app/module/ui/notifications.html",
            data: { pageTitle: 'Notifications and tooltips' }
        })
        .state('ui.badges_labels', {
            url: "/badges_labels",
            templateUrl: "app/module/ui/badges_labels.html",
            data: { pageTitle: 'Badges and labels and progress' }
        })
        .state('ui.video', {
            url: "/video",
            templateUrl: "app/module/ui/video.html",
            data: { pageTitle: 'Responsible Video' }
        })
        .state('ui.draggable', {
            url: "/draggable",
            templateUrl: "app/module/ui/draggable.html",
        ...
        .state('grid_options', {
            url: "/grid_options",
            templateUrl: "app/module/grid/grid_options.html",
        ...
        .state('miscellaneous.google_maps', {
            url: "/google_maps",
            templateUrl: "app/module/miscellaneous/google_maps.html",
        ...
        .state('miscellaneous.code_editor', {
            url: "/code_editor",
            templateUrl: "app/module/miscellaneous/code_editor.html",
        ...
        .state('miscellaneous.modal_window', {
            url: "/modal_window",
            templateUrl: "app/module/miscellaneous/modal_window.html",
            data: { pageTitle: 'Modal window' }
        })
        .state('miscellaneous.chat_view', {
            url: "/chat_view",
            templateUrl: "app/module/miscellaneous/chat_view.html",
            data: { pageTitle: 'Chat view' }
        })
        .state('miscellaneous.nestable_list', {
            url: "/nestable_list",
            templateUrl: "app/module/miscellaneous/nestable_list.html",
        ...
        .state('miscellaneous.notify', {
            url: "/notify",
            templateUrl: "app/module/miscellaneous/notify.html",
        ...
        .state('miscellaneous.timeline_2', {
            url: "/timeline_2",
            templateUrl: "app/module/miscellaneous/timeline_2.html",
            data: { pageTitle: 'Timeline version 2' }
        })
        .state('miscellaneous.forum_view', {
            url: "/forum_view",
            templateUrl: "app/module/miscellaneous/forum_view.html",
            data: { pageTitle: 'Forum - general view' }
        })
        .state('miscellaneous.forum_post_view', {
            url: "/forum_post_view",
            templateUrl: "app/module/miscellaneous/forum_post_view.html",
            data: { pageTitle: 'Forum - post view' }
        })
        .state('miscellaneous.diff', {
            url: "/diff",
            templateUrl: "app/module/miscellaneous/diff.html",
        ...
        .state('miscellaneous.sweet_alert', {
            url: "/sweet_alert",
            templateUrl: "app/module/miscellaneous/sweet_alert.html",
        ...
        .state('miscellaneous.idle_timer', {
            url: "/idle_timer",
            templateUrl: "app/module/miscellaneous/idle_timer.html",
        ...
        .state('miscellaneous.live_favicon', {
            url: "/live_favicon",
            templateUrl: "app/module/miscellaneous/live_favicon.html",
        ...
        .state('miscellaneous.spinners', {
            url: "/spinners",
            templateUrl: "app/module/miscellaneous/spinners.html",
            data: { pageTitle: 'Spinners' }
        })
        .state('miscellaneous.validation', {
            url: "/validation",
            templateUrl: "app/module/miscellaneous/validation.html",
            data: { pageTitle: 'Validation' }
        })
        .state('miscellaneous.agile_board', {
            url: "/agile_board",
            templateUrl: "app/module/miscellaneous/agile_board.html",
        ...
        .state('miscellaneous.masonry', {
            url: "/masonry",
            templateUrl: "app/module/miscellaneous/masonry.html",
        ...
        .state('miscellaneous.toastr', {
            url: "/toastr",
            templateUrl: "app/module/miscellaneous/toastr.html",
        ...
        .state('tables.static_table', {
            url: "/static_table",
            templateUrl: "app/module/table/table_basic.html",
        ...
        .state('tables.data_tables', {
            url: "/data_tables",
            templateUrl: "app/module/table/table_data_tables.html",
        ...
        .state('tables.foo_table', {
            url: "/foo_table",
            templateUrl: "app/module/table/foo_table.html",
        ...
        .state('tables.nggrid', {
            url: "/nggrid",
            templateUrl: "app/module/table/nggrid.html",
        ...
        .state('commerce.products_grid', {
            url: "/products_grid",
            templateUrl: "app/module/commerce/ecommerce_products_grid.html",
            data: { pageTitle: 'E-commerce grid' }
        })
        .state('commerce.product_list', {
            url: "/product_list",
            templateUrl: "app/module/commerce/ecommerce_product_list.html",
            data: { pageTitle: 'E-commerce product list' }
        })
        .state('commerce.orders', {
            url: "/orders",
            templateUrl: "app/module/commerce/ecommerce_orders.html",
            data: { pageTitle: 'E-commerce orders' }
        })
        .state('commerce.product', {
            url: "/product",
            templateUrl: "app/module/commerce/ecommerce_product.html",
        ...
        .state('commerce.product_details', {
            url: "/product_details",
            templateUrl: "app/module/commerce/ecommerce_product_details.html",
        ...
        .state('commerce.payments', {
            url: "/payments",
            templateUrl: "app/module/commerce/ecommerce_payments.html",
        ...
        .state('gallery.basic_gallery', {
            url: "/basic_gallery",
            templateUrl: "app/module/gallery/basic_gallery.html",
        ...
        .state('gallery.bootstrap_carousel', {
            ...
            templateUrl: "app/module/gallery/carousel.html",
            data: { pageTitle: 'Bootstrap carousel' }
        })
        .state('gallery.slick_gallery', {
            url: "/slick_gallery",
            templateUrl: "app/module/gallery/slick.html",
        ...
        .state('css_animations', {
            url: "/css_animations",
            templateUrl: "app/module/animation/css_animation.html",
        ...
        .state('landing', {
            url: "/landing",
            templateUrl: "app/module/landing/landing.html",
            data: { pageTitle: 'Landing page', specialClass: 'landing-page' }
        })
        .state('outlook', {
            url: "/outlook",
            templateUrl: "app/module/outlook/outlook.html",
            data: { pageTitle: 'Outlook view', specialClass: 'fixed-sidebar' }
        })
        .state('off_canvas', {
            url: "/off_canvas",
            templateUrl: "app/module/canvas/off_canvas.html",
