...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('dashboards', {
            abstract: true,
            url: "/dashboards",
            templateUrl: "app/component/views/common/content.html",
        })
        .state('dashboards.dashboard_1', {
            url: "/dashboard_1",
            templateUrl: "app/component/views/dashboard_1.html",
            resolve: {
        ...
        .state('dashboards.dashboard_2', {
            url: "/dashboard_2",
            templateUrl: "app/component/views/dashboard_2.html",
        ...
        .state('dashboards.dashboard_3', {
            url: "/dashboard_3",
            templateUrl: "app/component/views/dashboard_3.html",
        ...
        .state('dashboards_top', {
            abstract: true,
            url: "/dashboards_top",
            templateUrl: "app/component/views/common/content_top_navigation.html",
        })
        .state('dashboards_top.dashboard_4', {
            url: "/dashboard_4",
            templateUrl: "app/component/views/dashboard_4.html",
        ...
        .state('dashboards.dashboard_4_1', {
            url: "/dashboard_4_1",
            templateUrl: "app/component/views/dashboard_4_1.html",
            data: { pageTitle: 'Dashboard 4' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
        ...
        .state('dashboards.dashboard_5', {
            url: "/dashboard_5",
            templateUrl: "app/component/views/dashboard_5.html",
        ...
        .state('layouts', {
            url: "/layouts",
            templateUrl: "app/component/views/layouts.html",
        ...
        .state('charts.flot_chart', {
            url: "/flot_chart",
            templateUrl: "app/component/views/graph_flot.html",
        ...
        .state('charts.rickshaw_chart', {
            url: "/rickshaw_chart",
            templateUrl: "app/component/views/graph_rickshaw.html",
        ...
        .state('charts.peity_chart', {
            url: "/peity_chart",
            templateUrl: "app/component/views/graph_peity.html",
        ...
        .state('charts.sparkline_chart', {
            url: "/sparkline_chart",
            templateUrl: "app/component/views/graph_sparkline.html",
        ...
        .state('charts.chartjs_chart', {
            url: "/chartjs_chart",
            templateUrl: "app/component/views/chartjs.html",
        ...
        .state('charts.chartist_chart', {
            url: "/chartist_chart",
            templateUrl: "app/component/views/chartist.html",
        ...
        .state('mailbox.inbox', {
            url: "/inbox",
            templateUrl: "app/component/views/mailbox.html",
        ...
        .state('mailbox.email_view', {
            url: "/email_view",
            templateUrl: "app/component/views/mail_detail.html",
            data: { pageTitle: 'Mail detail' }
        })
        .state('mailbox.email_compose', {
            url: "/email_compose",
            templateUrl: "app/component/views/mail_compose.html",
        ...
        .state('mailbox.email_template', {
            url: "/email_template",
            templateUrl: "app/component/views/email_template.html",
            data: { pageTitle: 'Mail compose' }
        })
        .state('widgets', {
            url: "/widgets",
            templateUrl: "app/component/views/widgets.html",
        ...
        .state('metrics', {
            url: "/metrics",
            templateUrl: "app/component/views/metrics.html",
        ...
        .state('forms.basic_form', {
            url: "/basic_form",
            templateUrl: "app/component/views/form_basic.html",
        ...
        .state('forms.advanced_plugins', {
            ...
            templateUrl: "app/component/views/form_advanced.html",
        ...
        .state('forms.wizard', {
            url: "/wizard",
            templateUrl: "app/component/views/form_wizard.html",
        ...
        .state('forms.wizard.step_one', {
            url: '/step_one',
            templateUrl: 'app/component/views/wizard/step_one.html',
            data: { pageTitle: 'Wizard form' }
        })
        .state('forms.wizard.step_two', {
            url: '/step_two',
            templateUrl: 'app/component/views/wizard/step_two.html',
            data: { pageTitle: 'Wizard form' }
        })
        .state('forms.wizard.step_three', {
            url: '/step_three',
            templateUrl: 'app/component/views/wizard/step_three.html',
            data: { pageTitle: 'Wizard form' }
        })
        .state('forms.file_upload', {
            url: "/file_upload",
            templateUrl: "app/component/views/form_file_upload.html",
        ...
        .state('forms.text_editor', {
            url: "/text_editor",
            templateUrl: "app/component/views/form_editors.html",
        ...
        .state('app.contacts', {
            url: "/contacts",
            templateUrl: "app/component/views/contacts.html",
            data: { pageTitle: 'Contacts' }
        })
        .state('app.contacts_2', {
            url: "/contacts_2",
            templateUrl: "app/component/views/contacts_2.html",
            data: { pageTitle: 'Contacts 2' }
        })
        .state('app.profile', {
            url: "/profile",
            templateUrl: "app/component/views/profile.html",
            data: { pageTitle: 'Profile' }
        })
        .state('app.profile_2', {
            url: "/profile_2",
            templateUrl: "app/component/views/profile_2.html",
        ...
        .state('app.projects', {
            url: "/projects",
            templateUrl: "app/component/views/projects.html",
            data: { pageTitle: 'Projects' }
        })
        .state('app.project_detail', {
            url: "/project_detail",
            templateUrl: "app/component/views/project_detail.html",
            data: { pageTitle: 'Project detail' }
        })
        .state('app.file_manager', {
            url: "/file_manager",
            templateUrl: "app/component/views/file_manager.html",
            data: { pageTitle: 'File manager' }
        })
        .state('app.calendar', {
            url: "/calendar",
            templateUrl: "app/component/views/calendar.html",
        ...
        .state('app.faq', {
            url: "/faq",
            templateUrl: "app/component/views/faq.html",
            data: { pageTitle: 'FAQ' }
        })
        .state('app.timeline', {
            url: "/timeline",
            templateUrl: "app/component/views/timeline.html",
            data: { pageTitle: 'Timeline' }
        })
        .state('app.pin_board', {
            url: "/pin_board",
            templateUrl: "app/component/views/pin_board.html",
            data: { pageTitle: 'Pin board' }
        })
        .state('app.invoice', {
            url: "/invoice",
            templateUrl: "app/component/views/invoice.html",
            data: { pageTitle: 'Invoice' }
        })
        .state('app.blog', {
            url: "/blog",
            templateUrl: "app/component/views/blog.html",
            data: { pageTitle: 'Blog' }
        })
        .state('app.article', {
            url: "/article",
            templateUrl: "app/component/views/article.html",
            data: { pageTitle: 'Article' }
        })
        .state('app.issue_tracker', {
            url: "/issue_tracker",
            templateUrl: "app/component/views/issue_tracker.html",
            data: { pageTitle: 'Issue Tracker' }
        })
        .state('app.clients', {
            url: "/clients",
            templateUrl: "app/component/views/clients.html",
            data: { pageTitle: 'Clients' }
        })
        .state('app.teams_board', {
            url: "/teams_board",
            templateUrl: "app/component/views/teams_board.html",
            data: { pageTitle: 'Teams board' }
        })
        .state('app.social_feed', {
            url: "/social_feed",
            templateUrl: "app/component/views/social_feed.html",
            data: { pageTitle: 'Social feed' }
        })
        .state('app.vote_list', {
            url: "/vote_list",
            templateUrl: "app/component/views/vote_list.html",
        ...
        .state('pages.search_results', {
            url: "/search_results",
            templateUrl: "app/component/views/search_results.html",
            data: { pageTitle: 'Search results' }
        })
        .state('pages.empy_page', {
            url: "/empy_page",
            templateUrl: "app/component/views/empty_page.html",
            data: { pageTitle: 'Empty page' }
        })
        .state('login', {
            url: "/login",
            templateUrl: "app/component/views/login.html",
            data: { pageTitle: 'Login', specialClass: 'gray-bg' }
        })
        .state('login_two_columns', {
            url: "/login_two_columns",
            templateUrl: "app/component/views/login_two_columns.html",
            data: { pageTitle: 'Login two columns', specialClass: 'gray-bg' }
        })
        .state('register', {
            url: "/register",
            templateUrl: "app/component/views/register.html",
            data: { pageTitle: 'Register', specialClass: 'gray-bg' }
        })
        .state('lockscreen', {
            url: "/lockscreen",
            templateUrl: "app/component/views/lockscreen.html",
            data: { pageTitle: 'Lockscreen', specialClass: 'gray-bg' }
        })
        .state('forgot_password', {
            url: "/forgot_password",
            templateUrl: "app/component/views/forgot_password.html",
            data: { pageTitle: 'Forgot password', specialClass: 'gray-bg' }
        })
        .state('errorOne', {
            url: "/errorOne",
            templateUrl: "app/component/views/errorOne.html",
            data: { pageTitle: '404', specialClass: 'gray-bg' }
        })
        .state('errorTwo', {
            url: "/errorTwo",
            templateUrl: "app/component/views/errorTwo.html",
        ...
        .state('ui.typography', {
            url: "/typography",
            templateUrl: "app/component/views/typography.html",
            data: { pageTitle: 'Typography' }
        })
        .state('ui.icons', {
            url: "/icons",
            templateUrl: "app/component/views/icons.html",
            data: { pageTitle: 'Icons' }
        })
        .state('ui.buttons', {
            url: "/buttons",
            templateUrl: "app/component/views/buttons.html",
            data: { pageTitle: 'Buttons' }
        })
        .state('ui.tabs_panels', {
            url: "/tabs_panels",
            templateUrl: "app/component/views/tabs_panels.html",
            data: { pageTitle: 'Panels' }
        })
        .state('ui.tabs', {
            url: "/tabs",
            templateUrl: "app/component/views/tabs.html",
            data: { pageTitle: 'Tabs' }
        })
        .state('ui.notifications_tooltips', {
            url: "/notifications_tooltips",
            templateUrl: "app/component/views/notifications.html",
            data: { pageTitle: 'Notifications and tooltips' }
        })
        .state('ui.badges_labels', {
            url: "/badges_labels",
            templateUrl: "app/component/views/badges_labels.html",
            data: { pageTitle: 'Badges and labels and progress' }
        })
        .state('ui.video', {
            url: "/video",
            templateUrl: "app/component/views/video.html",
            data: { pageTitle: 'Responsible Video' }
        })
        .state('ui.draggable', {
            url: "/draggable",
            templateUrl: "app/component/views/draggable.html",
        ...
        .state('grid_options', {
            url: "/grid_options",
            templateUrl: "app/component/views/grid_options.html",
        ...
        .state('miscellaneous.google_maps', {
            url: "/google_maps",
            templateUrl: "app/component/views/google_maps.html",
        ...
        .state('miscellaneous.code_editor', {
            url: "/code_editor",
            templateUrl: "app/component/views/code_editor.html",
        ...
        .state('miscellaneous.modal_window', {
            url: "/modal_window",
            templateUrl: "app/component/views/modal_window.html",
            data: { pageTitle: 'Modal window' }
        })
        .state('miscellaneous.chat_view', {
            url: "/chat_view",
            templateUrl: "app/component/views/chat_view.html",
            data: { pageTitle: 'Chat view' }
        })
        .state('miscellaneous.nestable_list', {
            url: "/nestable_list",
            templateUrl: "app/component/views/nestable_list.html",
        ...
        .state('miscellaneous.notify', {
            url: "/notify",
            templateUrl: "app/component/views/notify.html",
        ...
        .state('miscellaneous.timeline_2', {
            url: "/timeline_2",
            templateUrl: "app/component/views/timeline_2.html",
            data: { pageTitle: 'Timeline version 2' }
        })
        .state('miscellaneous.forum_view', {
            url: "/forum_view",
            templateUrl: "app/component/views/forum_view.html",
            data: { pageTitle: 'Forum - general view' }
        })
        .state('miscellaneous.forum_post_view', {
            url: "/forum_post_view",
            templateUrl: "app/component/views/forum_post_view.html",
            data: { pageTitle: 'Forum - post view' }
        })
        .state('miscellaneous.diff', {
            url: "/diff",
            templateUrl: "app/component/views/diff.html",
        ...
        .state('miscellaneous.sweet_alert', {
            url: "/sweet_alert",
            templateUrl: "app/component/views/sweet_alert.html",
        ...
        .state('miscellaneous.idle_timer', {
            url: "/idle_timer",
            templateUrl: "app/component/views/idle_timer.html",
        ...
        .state('miscellaneous.live_favicon', {
            url: "/live_favicon",
            templateUrl: "app/component/views/live_favicon.html",
        ...
        .state('miscellaneous.spinners', {
            url: "/spinners",
            templateUrl: "app/component/views/spinners.html",
            data: { pageTitle: 'Spinners' }
        })
        .state('miscellaneous.validation', {
            url: "/validation",
            templateUrl: "app/component/views/validation.html",
            data: { pageTitle: 'Validation' }
        })
        .state('miscellaneous.agile_board', {
            url: "/agile_board",
            templateUrl: "app/component/views/agile_board.html",
        ...
        .state('miscellaneous.masonry', {
            url: "/masonry",
            templateUrl: "app/component/views/masonry.html",
        ...
        .state('miscellaneous.toastr', {
            url: "/toastr",
            templateUrl: "app/component/views/toastr.html",
        ...
        .state('tables.static_table', {
            url: "/static_table",
            templateUrl: "app/component/views/table_basic.html",
        ...
        .state('tables.data_tables', {
            url: "/data_tables",
            templateUrl: "app/component/views/table_data_tables.html",
        ...
        .state('tables.foo_table', {
            url: "/foo_table",
            templateUrl: "app/component/views/foo_table.html",
        ...
        .state('tables.nggrid', {
            url: "/nggrid",
            templateUrl: "app/component/views/nggrid.html",
        ...
        .state('commerce.products_grid', {
            url: "/products_grid",
            templateUrl: "app/component/views/ecommerce_products_grid.html",
            data: { pageTitle: 'E-commerce grid' }
        })
        .state('commerce.product_list', {
            url: "/product_list",
            templateUrl: "app/component/views/ecommerce_product_list.html",
            data: { pageTitle: 'E-commerce product list' }
        })
        .state('commerce.orders', {
            url: "/orders",
            templateUrl: "app/component/views/ecommerce_orders.html",
            data: { pageTitle: 'E-commerce orders' }
        })
        .state('commerce.product', {
            url: "/product",
            templateUrl: "app/component/views/ecommerce_product.html",
        ...
        .state('commerce.product_details', {
            url: "/product_details",
            templateUrl: "app/component/views/ecommerce_product_details.html",
        ...
        .state('commerce.payments', {
            url: "/payments",
            templateUrl: "app/component/views/ecommerce_payments.html",
        ...
        .state('gallery.basic_gallery', {
            url: "/basic_gallery",
            templateUrl: "app/component/views/basic_gallery.html",
        ...
        .state('gallery.bootstrap_carousel', {
            ...
            templateUrl: "app/component/views/carousel.html",
            data: { pageTitle: 'Bootstrap carousel' }
        })
        .state('gallery.slick_gallery', {
            url: "/slick_gallery",
            templateUrl: "app/component/views/slick.html",
        ...
        .state('css_animations', {
            url: "/css_animations",
            templateUrl: "app/component/views/css_animation.html",
        ...
        .state('landing', {
            url: "/landing",
            templateUrl: "app/component/views/landing.html",
            data: { pageTitle: 'Landing page', specialClass: 'landing-page' }
        })
        .state('outlook', {
            url: "/outlook",
            templateUrl: "app/component/views/outlook.html",
            data: { pageTitle: 'Outlook view', specialClass: 'fixed-sidebar' }
        })
        .state('off_canvas', {
            url: "/off_canvas",
            templateUrl: "app/component/views/off_canvas.html",
